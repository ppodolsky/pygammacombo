...
#ifndef PDF_GLWADS_DKDpi_hh_Dmix_newVars_xy_h
#define PDF_GLWADS_DKDpi_hh_Dmix_newVars_xy_h
...
///
class PDF_GLWADS_DKDpi_hh_Dmix_newVars_xy : public PDF_Abs
{
	public:
		PDF_GLWADS_DKDpi_hh_Dmix_newVars_xy(config cObs=lumi3fb, config cErr=lumi3fb, config cCor=lumi3fb,
				double Mxy=0, ParametersAbs* pars=0, TString d=".");
		~PDF_GLWADS_DKDpi_hh_Dmix_newVars_xy();
