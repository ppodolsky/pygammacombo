...
GammaComboEngine& loadMainGammaComboEngine(int argc, char* argv[])
{
	...
	gc.addPdf(162, new PDF_GLWADS_DKDpi_hh_Dmix_newVars(lumi3fb, lumi3fb, lumi3fb, 0.0),  "GLWADS, B->Dh, D->hh, 3fb-1 No D mixing");
	gc.addPdf(163, new PDF_GLWADS_DK_hh_Dmix_newVars(lumi3fb, lumi3fb, lumi3fb, 0.0),     "GLWADS, B->DK, D->hh, 3fb-1 No D mixing");
	gc.addPdf(164, new PDF_GLWADS_DKDpi_K3pi_Dmix_newVars(lumi3fb, lumi3fb, lumi3fb, 0.0),"GLWADS, B->Dh, D->hhhh, 3fb-1 No D mixing");
	gc.addPdf(165, new PDF_GLWADS_DK_K3pi_Dmix_newVars(lumi3fb, lumi3fb, lumi3fb, 0.0),   "GLWADS, B->DK, D->hhhh, 3fb-1 No D mixing");
	...
	gc.getCombiner(119)->addPdf(gc[66],gc[112]);            // 3-body GLW/ADS, B->DK    , D->KSKpi, 3fb-1, No D mixing, CLEO D->KSKpi
	// could switch 52 -> 112 to get CLEO histogram instead
	...
	// Full
	// TO BE ADDED
	gc.newCombiner(120, "lhcp2015full_no_dmix", "full LHCP2015 no D mix");
	// add stuff
	...
	gc.getCombiner(125)->addPdf( gc[100] );
	gc.getCombiner(125)->addPdf( gc[74] );
	gc.getCombiner(125)->addPdf( gc[150] );
	gc.getCombiner(125)->addPdf( gc[146] );
	...
	gc.getCombiner(126)->addPdf( gc[100] );
	gc.getCombiner(126)->addPdf( gc[74]  );
	gc.getCombiner(126)->addPdf( gc[150] );
	gc.getCombiner(126)->addPdf( gc[146] );
	...
	gc.getCombiner(127)->addPdf( gc[135] );
	gc.getCombiner(127)->addPdf( gc[149] );
	gc.getCombiner(127)->addPdf( gc[148] );
	...
	gc.getCombiner(128)->addPdf( gc[135] );
	gc.getCombiner(128)->addPdf( gc[149] );
	gc.getCombiner(128)->addPdf( gc[148] );
	...
	gc.getCombiner(129)->addPdf( gc[112] );
