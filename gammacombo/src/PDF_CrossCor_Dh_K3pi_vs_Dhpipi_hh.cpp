...
#include "PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh.h"
	...
	PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh::PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh(PDF_Abs* pdf1, PDF_Abs* pdf2, config cCor)
: PDF_CrossCorAbs(pdf1,pdf2)
{
	name = "CrossCor_Dh_K3pi_vs_Dhpipi_hh";
...
PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh::~PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh(){}


void PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh::setCorrelations(config c)
{
	resetCorrelations();
	...
	switch(c)
	{
		...
		default:{
					cout << "PDF_CrossCor_Dh_K3pi_vs_Dhpipi_hh::setCorrelations() : ERROR : config "+ConfigToTString(c)+" not found." << endl;
					exit(1);
				}
	}
}
