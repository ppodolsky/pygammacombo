...
PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::~PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv(){}


void PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::initParameters()
{
...
void PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::initObservables()
{
...
void PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::setUncertainties(config c)
{
	switch(c){
		case lumi3fb:
			{
		...
		default:
			{
				cout << "PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::setUncertainties() : ERROR : config "+ConfigToTString(c)+" not found." << endl;
				exit(1);
			}
	}
}
...
void PDF_GLWADS_DKDpi_hh_Dmix_newVars_uv::buildPdf()
{
