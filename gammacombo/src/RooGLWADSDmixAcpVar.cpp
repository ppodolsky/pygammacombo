...
RooGLWADSDmixAcpVar::RooGLWADSDmixAcpVar(const char *name, const char *title,
      RooAbsReal& rb, 
      RooAbsReal& db,
      RooAbsReal& kb, 
      RooAbsReal& rf,
...
RooGLWADSDmixAcpVar::RooGLWADSDmixAcpVar(const RooGLWADSDmixAcpVar& other, const char* name) :  
...
RooGLWADSDmixAcpVar::~RooGLWADSDmixAcpVar() { }


Double_t RooGLWADSDmixAcpVar::evaluate() const 
{
  ...
  return (m.ABm2Dbfhm()-m.ABp2Dbfhp())/(m.ABm2Dbfhm()+m.ABp2Dbfhp()) + AcpD;
}

ClassImp(RooGLWADSDmixAcpVar)
