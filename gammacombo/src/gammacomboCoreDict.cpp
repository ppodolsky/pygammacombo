...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const vector<int>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<int>", -2, "/usr/local/Cellar/root/5.34.34/lib/root/cint/cint/lib/prec_stl/vector", 49,
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const vector<string>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<string>", -2, "/usr/local/Cellar/root/5.34.34/lib/root/cint/cint/lib/prec_stl/vector", 49,
