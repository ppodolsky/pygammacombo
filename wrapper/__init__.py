...
config = utils_namespace.add_enum('config', ['year2014','babar','babar2007','babar2008',
                                    'babar2010','babar2012','babar_dg','babar_dpi0','belle','belle2005cleo2009',
                                    'belle2006','belle2007','belle2009','belle2012','belle2012preliminary',
                                    'belle2013','belle2014','belle2013cleo2014', 'belle_dg', 'belle_dpi0',
                                    'belle_md','cdf2007','cdf2012',
                                    'cdf2013','check', 'ckm2014','cleo','cleo2001','cleo2009','cleo2012','cleo2014',
                                    ...
                                    'lhcbphis','lhcbcomb','lhcb_kk', 'lhcb_old', 'lhcb_pipi', 'lumi40pb','lumi1fb','lumi1fbConfcFit',
                                    ...
                                    'nophicorr','onlyGsDGs','pdg','sneha','test', 'test1', 'test2', 'test3', 'test4',
                                    'toy','truth','useBicubic',
...
gammacombo_utils_namespace.add_function('getHfagGammaComboEngine',
                                             retval('GammaComboEngine&'),
                                             [param('const char*', 'argv')])
