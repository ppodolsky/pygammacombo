...
wrapper = megazord \
    ...
    .add_library_path('./')\
    .add_library_path(megazord.library_paths("root"))\
    .add_library_path(megazord.library_paths("python3"))\
    .add_include_path(megazord.include_paths("root"))\
    .add_include_path(megazord.include_paths("python3"))\
